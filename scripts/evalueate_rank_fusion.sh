...
python ${REPO_DIR}/disentangled_information_needs/evaluation/rank_fusion.py --task 'irds:car/v1.5/test200' \
        --output_dir $OUT_DIR/ \
        --variations_file $OUT_DIR/car-v1.5-test200_weakly_supervised_variations_sample_None.csv

python ${REPO_DIR}/disentangled_information_needs/evaluation/rank_fusion.py --task 'irds:antique/test' \
        --output_dir $OUT_DIR/ \
