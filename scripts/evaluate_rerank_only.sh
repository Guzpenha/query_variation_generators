...
python ${REPO_DIR}/disentangled_information_needs/evaluation/query_rewriting_reranker_only.py --task 'irds:msmarco-passage/trec-dl-2019/judged' \
        --output_dir $OUT_DIR/ \
...
python ${REPO_DIR}/disentangled_information_needs/evaluation/query_rewriting_reranker_only.py --task 'irds:antique/train/split200-valid' \
        --output_dir $OUT_DIR/ \
