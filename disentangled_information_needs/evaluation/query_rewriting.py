...
def main():
    ...
    df_scores_original_q = bm_25.transform(query_variations[['query','qid']].drop_duplicates())[['qid', 'docno', 'score']]
    df_scores_original_q.columns = [['qid', 'docno', 'score_original_query']]        
    score_dfs = [df_scores_original_q]
    for variation_name, df in zip(variation_methods, bm25_res):
    ...
    cor_df.to_csv("{}/query_corr_{}.csv".format(args.output_dir, args.task.replace("/",'-')))
